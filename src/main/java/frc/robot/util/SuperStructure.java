...
public class SuperStructure extends SubsystemBase {
	...
	public Command SetHopperRollers() {
		return HopperRollerSubsystem.setDutyCycle(0.8);
	}
	...
	// public Command SetHopperSP() {
	// 	return HopperExtenderSubsystem.setHeightSetpoint(Meters.of(0.3));
	// }
	...
	// 	return ClimberSubsystem.set(0.9);
	// }

	// public Command SetClimberPWRrev() {

	// 	return ClimberSubsystem.set(-0.5);
	// }
	// public Command SetClimberPWRoff() {

	// 	return ClimberSubsystem.set(0);
	// }
	//end climb

	public Command SetKickerPowerHigh() {

		return kickerSubsystem.setDutyCycle(-1);
	}
