...
// Example comes fro: https://github.com/BroncBotz3481/FRC2026
public class ShootOnTheMoveCommand_ToF extends Command
{
  ...
  public ShootOnTheMoveCommand_ToF(TurretSubsystem turret, FlywheelSubsystem shooter, SwerveSubsystem swerveDrive)//HoodSubsystem hood, 
  {
    SmartDashboard.putData("ShootOnTheMoveField", debugField);
    estimatedPose = () -> {
      // Calculate estimated pose while accounting for phase delay
      ChassisSpeeds robotRelativeVelocity = swerveDrive.getRobotVelocity();
  ...
  public void execute()
  {
    ...
    Translation2d target = new Translation2d(Inches.of(182.11), Inches.of(158.84));
  ...
  public void end(boolean interrupted)
  {
    ...
    turretSubsystem.setAngleSetpoint(Degrees.of(0));
  }
