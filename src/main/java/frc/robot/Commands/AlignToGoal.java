...
public class AlignToGoal extends Command
{
  ...
  public AlignToGoal(SwerveSubsystem swerveSubsystem, FlywheelSubsystem flywheelSubsystem, SwerveInputStream driveAngularVelocity,
                     Pose2d targetPose)
  {
    ...
    addRequirements(this.swerveSubsystem, this.flywheelSubsystem);
  }
  ...
  public void execute()
  {
    ...
    swerveSubsystem.driveFieldOriented(() -> ChassisSpeeds.fromFieldRelativeSpeeds(originalSpeed,swerveSubsystem.getHeading()));
    flywheelSubsystem.setRPM(newHorizontalSpeed);
  }
